...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private Drawable mAddButtonPlus;
    ...
    private CustomPlusAnimator plusAnimator = new DefaultPlusAnimator();
    ...
    public interface CustomPlusAnimator {
    ...
    class DefaultPlusAnimator implements CustomPlusAnimator {
        ...
        @Override
        public Animator getCollapseAnimator(Drawable drawable, Interpolator interpolator) {
            Animator collapseAnimator = ObjectAnimator.ofFloat(mRotatingDrawable, "rotation", EXPANDED_PLUS_ROTATION, COLLAPSED_PLUS_ROTATION);
        ...
        @Override
        public Animator getExpandAnimator(Drawable drawable, Interpolator interpolator) {
            Animator expandAnimator = ObjectAnimator.ofFloat(mRotatingDrawable, "rotation", COLLAPSED_PLUS_ROTATION, EXPANDED_PLUS_ROTATION);
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        mAddButtonPlus = attr.getDrawable(R.styleable.FloatingActionsMenu_fab_addButtonPlusIcon);
    ...
    public void setPlusAnimator(CustomPlusAnimator plusAnimator) {
        this.plusAnimator = plusAnimator;
        createAddButton(getContext());
    }

    public void setPlusIcon(Drawable drawable) {
        mAddButton.setIconDrawable(drawable);
        mAddButtonPlus=drawable;
    }

    public Drawable getAddButtonPlus() {
        return mAddButtonPlus;
    }
    ...
    private void createAddButton(Context context) {
        ...
        int index = -1;
        if (mAddButton != null) {
            layoutParams = mAddButton.getLayoutParams();
            index = indexOfChild(mAddButton);
        ...
        mAddButton = new AddFloatingActionButton(context) {
            ...
            Drawable getIconDrawable() {
                Drawable drawable = plusAnimator.getIconDrawable(super.getIconDrawable());
                mExpandAnimation.play(plusAnimator.getExpandAnimator(drawable,interpolator));
                mCollapseAnimation.play(plusAnimator.getCollapseAnimator(drawable,interpolator));
                return drawable;
            }
        };
        mAddButton.setIconDrawable(mAddButtonPlus);
        ...
        if (index != -1) {
            addView(mAddButton, index, layoutParams);
        } else {
